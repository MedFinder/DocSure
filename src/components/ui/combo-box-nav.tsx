      ...
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          <Button
            ...
            role="combobox"
            aria-expanded={open}
            className="w-full justify-between outline-none border-none shadow-none hover:bg-white mt-1  text-sm text-black placeholder:text-muted-foreground  "
        ...
        <PopoverContent className="w-full min-w-md min-w-auto p-0">
          <Command>
            <CommandInput
              placeholder="Search..."
              value={query}
