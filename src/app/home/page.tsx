...
//     // Set the prefilled values if they exist
//     if (address) {
//       setPrefilledAddress(address);
//       sessionStorage.setItem("selectedAddress", address);
//       setAddressLocation(address); // Set the address location for input field
...
//     if (specialty) {
//       setPrefilledSpecialty(specialty);
//       sessionStorage.setItem("selectedSpecialty", specialty); // Store in sessionStorage
//     }
//   }, [searchParams]);
//   // const handleOnPlacesChanged = (index) => {
//   //   if (inputRefs.current[index]) {
...
//                       options={medicalSpecialtiesOptions}
//                       placeholder="Medical specialty"
//                       selected={formik.values.specialty || prefilledSpecialty} // Prefill specialty
//                       onChange={(value) =>
//                         formik.setFieldValue("specialty", value)
//                       }
//                       clearable={false}
